angular.module("app").run(["$templateCache", function($templateCache) {
    ...
    //     "                       <div class=\"row\">\r" +
    //     "\n" +
    //     "                            <div class=\"col-xs-6\"><a class=\"navbar-brand\"  ng-click=\"home()\"><img class=\"navLogo\" src=\"img/checkmate-trans.png\"/></a></div>\r" +
		// 		"\n" +
		// 		"                           </div>\r" +
    //     "\n" +
    //     "            </div>\r" +
    ...
    $templateCache.put("home.html",
        ...
        "\n" +
        "    <button type=\"button\" class=\"btnNormal btnWhite\" ng-click=\"settings()\">Settings</button>\r" +
        "\n" +
        " </div>\r" +
        "\n"
    );
    ...
    $templateCache.put("report_saved.html",
        "<nav-header></nav-header>\r" +
        "\n" +
        "    <div class=\"list-group content\">\r" +
        "\n" +
        "        <ul class=\"list-group-item list-no-bullet\" ng-repeat=\"savedChecklist in $storage.savedChecklist | orderBy:'index' : reverse\">\r" +
        "\n" +
        "            <li class=\"savedItem\" content=\"telephone=no\" ng-click=\"edit($index)\">{{savedChecklist.name}}:{{savedChecklist.title}} - {{savedChecklist.dateStamp | date: 'dd-MMM-yyyy'}}</li>\r" +
        "\n" +
        "        </ul>\r" +
        "\n" +
        "    </div>\r" +
